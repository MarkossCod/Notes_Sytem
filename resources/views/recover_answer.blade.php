...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .card { background: white; border-radius: 24px; padding: 40px 36px; width: 100%; max-width: 400px; z-index: 2; position: relative; }
        ...
        .question-box { background: #FFF3E0; border-left: 4px solid #FF6D00; border-radius: 10px; padding: 14px 16px; margin-bottom: 20px; font-size: 14px; font-weight: 600; color: #1a1a1a; }
